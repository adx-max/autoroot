...
BANNER  = MAGENTA + "  ___  _ __ ___ __ _   \n"
BANNER  += YELLOW + "  | || | |  |  ||  |\/ \n"
BANNER  += BLUE + "    |-|| | -_||-- |- |   \n"
BANNER  += RED + "     |_|| | |_ |___|_  | |" + CYAN + " bntchscrt@gmail.com or +97431000704 \n"
...
def main():
    ...
    try:
        ...
        print("\n[" + RED + "!" + WHITE + "] " + RED + "Bruv, BigBen hates when you interupt with keyboard, stop it")
